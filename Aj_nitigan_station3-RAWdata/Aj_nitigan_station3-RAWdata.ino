...
const int wind_speed_Pin = 39;  // Analog input pin that the potentiometer is attached to
const int wind_dir_Pin = 15;  // Analog input pin that the potentiometer is attached to
