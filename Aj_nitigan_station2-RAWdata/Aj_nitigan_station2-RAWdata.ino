...
const int wind_dir_Pin = 12;  // Analog input pin that the potentiometer is attached to
...
bool read_all()
{
  ...
  Send_command("AT+CHTTPSEND=0,1,\"/aj_nitigan_2RAW.php\",,\"application/json\"," + Payload);
  Serial.println("Command Status : " + String(cmm_state));
